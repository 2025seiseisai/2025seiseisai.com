            ...
            <ul>
                {toc.map((item) => (
                    <a href={`#${item.id}`} key={item.id}>
                        <li
                            className={`mx-[5px] flex w-full text-[14px]/[1.7] transition-all duration-300 before:content-['・'] hover:opacity-75 b:text-[13px]/[1.7] ${item.id === activeTitleId && "bg-[#de0d2221]"}`}
                        >
