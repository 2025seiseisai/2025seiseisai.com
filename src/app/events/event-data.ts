...
export const locations = ["中庭","体育館","転心殿前","圓融館","小講堂","視聴覚室","4A","音楽室","2B","3A","3B","4E","5E","情報教室","物理室","地学室","上グラウンド","お化け屋敷","pending"] as const;
export const eventData: EventData[] = [
    ...
    {
        name: "T(DJ)²",
        description:"東大寺生によるDJイベントです。ジャンル問わず様々な曲を流します。1日数名程度、持ち時間は30〜50分を想定しています。",
        ticket: "pending",
        events: [
            {
                day: 1,
