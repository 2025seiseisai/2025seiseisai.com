...
import { Rects, Polygons } from "@/settings/mapdata";
...
function BuildScene(scene: THREE.Scene, camera: THREE.PerspectiveCamera) {
    ...
    const texture = loader.load("/tdj-map/image.png");
    texture.colorSpace = THREE.SRGBColorSpace;
    const tdjplane = new THREE.Mesh(new THREE.PlaneGeometry(2000, 2000, 1, 1), new THREE.MeshBasicMaterial({ map: texture }));
