...
export default function Slide() {
    ...
    return (
        <div
            className={`mb-[20px] w-full overflow-hidden [clip-path:polygon(0_10%,100%_0,100%_90%,0_100%)] md:mt-[30px]
                md:mb-[30px] md:[clip-path:polygon(0_20%,100%_0,100%_80%,0_100%)]`}
        >
