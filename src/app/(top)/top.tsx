        ...
        <>
            <div
                className={
                    ...
                    `top_loading z-20000 flex h-[100dvh] w-full items-center justify-center overflow-hidden
                    bg-[#ffffff]`
                }
                style={{
                    transition: "none",
            ...
            >
                ...
                <div className={"absolute flex h-[14%] w-[42%] items-center justify-center brightness-0 filter"}>
                    <Logo
                        className={
                            // eslint-disable-next-line
                            `top_loading_logo h-auto max-h-full w-auto max-w-full
                            transform-[translateX(10%)_translateY(-15%)] transition-[opacity] duration-200`
                        }
                        style={{ opacity: 0 }}
                    />
                </div>
            ...
            <div
                className={`${styles.wave_container} relative z-10000 mt-[-45px] flex w-full items-center justify-center
                    overflow-hidden bg-white md:mt-[-64px]`}
            >
