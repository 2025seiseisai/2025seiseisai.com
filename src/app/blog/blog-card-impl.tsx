        ...
        >
            ...
            {blog && (
                <>
                    ...
                    <p className="mr-auto ml-[8.33333%] h-4.75 w-max max-w-2/3 truncate rounded-[0.3125rem] bg-pri-red px-1.5 text-sm/normal text-[#ffffff] @[18.75rem]:mt-[1.03rem] @[18.75rem]:ml-auto @[18.75rem]:max-w-[calc(83%-6rem)]">
                        ＃{blog.topic}
                    </p>
