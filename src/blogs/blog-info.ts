...
![第59回菁々祭「RESONANCE」ロゴの構想](image 1.png)
...
![変な踊りを見せる今年度のセクション長2](image 1.png)
...
![パート員募集用特設サイト『パートの選び方』](image 1.png)
...
![トップページのアニメーションは一度動画として試作された](image 2.png)
...
![製作セクション長(奥)と技術セクション長(手前)](image 3.png)
...
![当時のパンフレットのイベント一覧。どれもなかなかおもしろそうですよね。](image 1.png)
...
![去年の作品（去年は開催日に間に合わなかったそうだ）](image 1.png)
...
![こんな感じのモニュメントが作られます！](image 2.png)
...
![先輩方が、切り出したベニヤの置き場所と重ね方を話し合っています。](image 1.png)

先輩方が、切り出したベニヤの置き場所と重ね方を話し合っています。

![確定したようです。](image 2.png)

確定したようです。

![色が塗られました。この時点で、菁々祭開始まであと2日でした。](image 3.png)

色が塗られました。この時点で、菁々祭開始まであと2日でした。

## ５.完成

![組み立てが完了し、無事完成しました。](image 4.png)

組み立てが完了し、無事完成しました。

![菁々祭前日。菁々祭が始まるのが楽しみと言わんばかりの佇まいです。](image 5.png)
...
![ロゴモニュメントの裏面。作業は当日の朝7時半から始められ、開場時間までかかりました。](image 6.png)

ロゴモニュメントの裏面。作業は当日の朝7時半から始められ、開場時間までかかりました。

# 当日

![来場者の方々に感謝です。](image 7.png)

来場者の方々に感謝です。

![菁々祭2日目の夕方。祭は刹那に過ぎてゆきます。](image 8.png)
...
`,
    ...
    "59/15": {
        ...
        images: {
            "image 1.png": Image34,
            "image 10.png": Image35,
            "image 11.png": Image36,
            "image 12.png": Image37,
            "image 13.png": Image38,
            "image 14.png": Image39,
            "image 15.png": Image40,
            "image 16.png": Image41,
            "image 17.png": Image42,
            "image 18.png": Image43,
            "image 19.png": Image44,
            "image 2.png": Image45,
            "image 20.png": Image46,
            "image 21.png": Image47,
            "image 22.png": Image48,
            "image 23.png": Image49,
            "image 24.png": Image50,
            "image 25.png": Image51,
            "image 26.png": Image52,
            "image 27.png": Image53,
            "image 28.png": Image54,
            "image 29.png": Image55,
            "image 3.png": Image56,
            "image 30.png": Image57,
            "image 31.png": Image58,
            "image 32.png": Image59,
            "image 33.png": Image60,
            "image 34.png": Image61,
            "image 4.png": Image62,
            "image 5.png": Image63,
            "image 6.png": Image64,
            "image 7.png": Image65,
...
![Adobe Illustratorでのマージンの設定の様子](image 7.png)
...
![「ごあいさつ」ページの写真](image 14.png)

「ごあいさつ」ページの写真

![本郷校長のサイン](image 15.png)
...
![校内展示ページ（中学棟1F）](image 17.png)

校内展示ページ（中学棟1F）

![校内展示ページ（中学棟2F）](image 18.png)

校内展示ページ（中学棟2F）

![校内展示ページ（中学棟3F）](image 19.png)

校内展示ページ（中学棟3F）

![校内展示ページ（高校棟1・2F）](image 20.png)

校内展示ページ（高校棟1・2F）

![校内展示ページ（高校棟3F）](image 21.png)

校内展示ページ（高校棟3F）

![校内展示ページ（高校棟4F）](image 22.png)
...
![タイムテーブル1日目ページ1](image 23.png)

タイムテーブル1日目ページ1

![タイムテーブル1日目ページ2](image 24.png)

タイムテーブル1日目ページ2

![タイムテーブル2日目ページ1](image 25.png)

タイムテーブル2日目ページ1

![タイムテーブル2日目ページ2](image 26.png)
...
![イベント紹介ページ1](image 27.png)

イベント紹介ページ1

![イベント紹介ページ2](image 28.png)
...
![Blenderによるグッズ製作の様子](image 31.png)
...
![去年の文化祭での部員の自作ボードゲームの様子](image 1.png)
...
![After Effects の編集画面。非常に複雑。](image 1.png)
...
![今年5月、灘で行われた招待試合の様子。めっちゃ盛り上がってたので東大寺でもみんなが楽しめる企画にしたいと副部長は語る。](image 1.png)
